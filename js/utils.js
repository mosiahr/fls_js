...
export const isNumber = (number) => typeof number === "number" && isFinite(number)
...
export const getRandomNumberArr = (minNumber, maxNumber, minLengthArr, maxLengthArr) => {
    let res = []
...
export const getRandomNumberArrFromUser = (messageForPrompt, defaultArr = []) => {
    let resArr = []
